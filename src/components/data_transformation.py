...
class DataTransformation:
    ...
    def get_data_transformer_obj(self):
        try:
            ...
            cat_pipeline=Pipeline(
                steps=[
                    ("imputer", SimpleImputer(strategy="most_frequent")), #missing values using mode
    ...
    def initiate_data_transformation(self, train_path, test_path):
        try:
            ...
            save_object(
                file_path = self.data_transformation_config.preprocessor_obj_fp,
                obj = preprocessing_obj
            )
            
            return(train_arr, test_arr, self.data_transformation_config.preprocessor_obj_fp)
